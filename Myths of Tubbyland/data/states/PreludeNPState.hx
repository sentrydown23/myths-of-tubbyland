...
var textPages:Array<String> = [
    "data/preludeinfo/prelude-nocturnal-protocol-0.txt"
];
var difficulties:Array<String> = ["easy", "normal", "hard", "hell"];
var curDifficulty:Int = 2; 

var hasMechPage:Bool = true;
var mechTextPath:String = "data/preludeinfo/prelude-nocturnal-protocol-mech.txt";
var mechImgPath:String = "preludeinfo/prelude-nocturnal-protocol-mech";
